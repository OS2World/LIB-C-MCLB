...
/*---------------------------------------------------------------------------
  ...
  This sample combines a multicolumn listbox and a drag/drop listbox to
  create a multicolumn drag/drop listbox.  This is a just combining the
  functions of sample #1 and sample #3.
...
{                                                                               
  ...
  switch (msg) {                                                                
    ...
    case WM_INITDLG: {
      ...
      DMLBInitialize(MCLBHwnd, NULLHANDLE);
